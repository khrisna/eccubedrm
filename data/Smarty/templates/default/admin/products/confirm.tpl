...
<!--{* CUORECUSTOM　START *}-->
                                ...
                                <tr>
                                    ...
                                    <td bgcolor="#ffffff" width="557" class="fs12n">
                                    <!--{$arrForm.filename|escape}-->
                                    </td>
                                </tr>
                                <tr>
                                    <td bgcolor="#f2f1ec" width="160" class="fs12n">ダウンロード商品用<BR />ファイル</td>
                                    <td bgcolor="#ffffff" width="557" class="fs12n">
                                    <!--{if $arrForm.realfilename != ""}-->
                                    <!--{$arrForm.realfilename|escape}-->
                                    <!--{/if}-->
                                    </td>
                                </tr>
<!--{* CUORECUSTOM　END *}-->
                            ...
                            <table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
                                ...
                                <tr>
                                    ...
                                    <table border="0" cellspacing="0" cellpadding="0" summary=" ">
                                        <tr>
                                            <td>
                                                <a href="#" onMouseover="chgImg('<!--{$TPL_DIR}-->img/contents/btn_back_on.jpg','back')" onMouseout="chgImg('<!--{$TPL_DIR}-->img/contents/btn_back.jpg','back');" onclick="fnModeSubmit('confirm_return','',''); return false;"><img src="<!--{$TPL_DIR}-->img/contents/btn_back.jpg" width="123" height="24" alt="前のページに戻る" border="0" name="back"></a>
