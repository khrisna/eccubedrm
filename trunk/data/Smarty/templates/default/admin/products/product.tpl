                            ...
                            <tr>
                                ...
                                <table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
                                    ...
                                    <tr>
                                        ...
                                        <td bgcolor="#ffffff" width="557" class="fs10n">
                                        <span class="red12"><!--{$arrErr.filename}--></span>
                                        <input type="text" name="filename" value="<!--{$arrForm.filename|escape}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{if $arrErr.filename != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}--><!--{/if}-->" size="60" class="box60" /><span class="red"> （上限<!--{$smarty.const.STEXT_LEN}-->文字）</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <!--{assign var=key value="down_file"}-->
                                        <td bgcolor="#f2f1ec" width="160" class="fs12n">ダウンロード商品用<BR>ファイルアップロード</td>
                                        <td bgcolor="#ffffff" width="557" class="fs12n">
                                        <span class="red12"><!--{$arrErr[$key]}--><!--{$arrErr.realfilename}--></span>
                                        <!--{if $arrForm.realfilename != ""}-->
                                        <!--{$arrForm.realfilename|escape}--><input type="hidden" name="realfilename" value="<!--{$arrForm.realfilename|escape}-->">　<a href="" onclick="selectAll('category_id'); fnModeSubmit('delete_down', 'down_key', '<!--{$key}-->'); return false;">[ファイルの取り消し]</a><br>
                                        <!--{/if}-->
