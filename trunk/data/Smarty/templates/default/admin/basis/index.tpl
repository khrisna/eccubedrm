                            ...
                            <tr>
                                ...
                                <table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
                                   ...
                                   <tr class="fs12n">
                                        ...
                                        <td bgcolor="#ffffff" width="537">
                                            <span class="red12"><!--{$arrErr.downloadable_days}--></span>
...
<!-- ダウンロード最大回数を有効にする場合は、コメント化を解除して下の２個のhidden値用のタグを削除してください
                                    <tr class="fs12n">
                                        <td bgcolor="#f2f1ec" width="180">ダウンロード<br>最大回数<span class="red"> *</span></td>
                                        <td bgcolor="#ffffff" width="537">
                                            <span class="red12"><!--{$arrErr.max_download_cnt}--></span>
                                            <input type="text" name="max_download_cnt" value="<!--{$arrForm.max_download_cnt|escape}-->" maxlength="<!--{$smarty.const.DOWNLOAD_CNT_LEN}-->" size="6" class="box6" style="<!--{if $arrErr.max_download_cnt != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}--><!--{/if}-->" /> 回まで可能
                                            <input type="checkbox" name="download_cnt_unlimited" value="1" <!--{if $arrForm.download_cnt_unlimited == "1"}-->checked<!--{/if}--> onclick="fnCheckLimit('max_download_cnt', 'download_cnt_unlimited', '<!--{$smarty.const.DISABLED_RGB}-->');"/>無制限
                                        </td>
                                    </tr>
-->
